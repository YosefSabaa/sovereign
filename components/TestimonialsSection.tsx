      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="h-1 w-12 bg-gradient-to-r from-transparent to-yellow-500 rounded-full" />
            <Star className="text-yellow-500 fill-yellow-500" size={20} />
            <div className="h-1 w-12 bg-gradient-to-l from-transparent to-yellow-500 rounded-full" />
          </div>
        ...
        >
          {TESTIMONIALS.map((t, i) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="relative bg-white rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-shadow border border-gray-100 overflow-hidden group"
            >
              {/* Quote icon */}
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-teal-50 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                <Quote size={28} className="text-teal-500/40" />
              </div>
              ...
              {/* Comment */}
              <p className="text-gray-700 leading-relaxed mb-6 relative z-10 min-h-[80px]">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-gray-100 relative z-10">
                <div
                  className={`w-12 h-12 rounded-full bg-gradient-to-br ${t.color} flex items-center justify-center text-white font-black text-lg shadow-lg`}
                >
                  {t.initial}
                </div>
